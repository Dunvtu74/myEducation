...
стек который знаю на данный момент: Python, JavaScript, C++, HTML/CSS(чуть-чуть). из интересного — FastAPI, aiogram, немного Kali Linux. На данный момент изучаю django и 1C
